...
#pragma omp parallel shared(np, ptr) private(i, level, my_id, my_list_size, my_own_blk, my_own_idx, my_blk_size, my_search_blk, my_search_idx, my_search_idx_max, my_write_blk, my_write_idx, my_search_count, idx, i_write)
    {
